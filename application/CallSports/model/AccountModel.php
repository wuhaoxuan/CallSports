...
//          Db::execute($createFriendInfoTable);
          ...
          $createActivityTable="create table if NOT EXISTS $user_id"."$activitySuffix (id int not null primary key AUTO_INCREMENT,uuid text not null,name text,sporttype text,type  int,members text,now_num int,state int,INDEX(uuid(36)))";
