...
//        $activityModel=new ActivityModel();
        $result=$this->activityModel->publish($user_id,$nickName,$name,$sporttype,$time,$address,$latitude,$longitude,$adcode,$total_num,$cost,$introduce);
        return $result;
    }
...
//        $actModel=new ActivityModel();
        $result=$this->activityModel->getAllActInfo($start,$offset,$adcode);
        return $result;
